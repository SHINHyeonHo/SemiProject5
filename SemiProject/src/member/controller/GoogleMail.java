...
public class GoogleMail {
	...
	public void sendmail(String recipient, String certificationCode)  
	    	...
	    	// 2. SMTP(Simple Mail Transfer Protocal) 서버의 계정 설정
	    	...
	    	// 제목 설정
	    	String subject = "localhost:9090/habibi/habibi.hb에서 회원님의 비밀번호를 찾기위한 인증코드 발송";
	    	msg.setSubject(subject);
	    	        
	    	// 보내는 사람의 메일주소
	    	String sender = "guzi951010@gmail.com";
