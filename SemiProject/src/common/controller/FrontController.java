...
@WebServlet(
		...
		urlPatterns = { "*.hb" }, 
		initParams = { 
				@WebInitParam(name = "propertyConfig", value = "C:/Users/hppngrh/Documents/KH/SemiProject/WebContent/WEB-INF/HbbCommand.properties", description = "*.hb 에 대한 클래스의 매핑파일")
		})
