...
@WebServlet(
		...
		urlPatterns = { "*.hb" }, 
		initParams = { 
				@WebInitParam(name = "propertyConfig", value = "/Users/user/eclipse-workspace/SemiProject5/SemiProject/WebContent/WEB-INF/HbbCommand.properties", description = "*.hb 에 대한 클래스의 매핑파일")
		})
