...
<c:forEach var="list" items="${prodList}">
	...
	<div id="pageBtn">
		...
		<button class="btn2" id="rp" onclick="func_movePage('/SemiProject/board/list.hb?prodCode=${list.prod_code}');">사용 후기</button>
		<button class="btn2" id="qp" onclick="func_movePage('/SemiProject/board/list.hb?prodCode=${list.prod_code}');">상품 Q&A</button>
	</div>
