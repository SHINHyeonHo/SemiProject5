...
<body>
    ...
    <div id="detailPage">
        <!-- 재료 및 사이즈 -->
        <div id="content">
            <p>재료 : <span>졸참나무 오크 원목 / 패브릭 쿠션</span></p>
            <p>색상 : <span>시어화이트, 메이플, 오크, 몰트브라운, 모카브라운</span></p>
            <p>Low 사이즈 : <span>w340 x d340 x h670 mm</span></p>
            <p>High 사이즈 : <span>w340 x d340 x h760 mm</span></p>
        </div>

        <!-- 제품 사진 -->
        <div id="prodImg">
            <img src="../images/ProdDetail/prodBigImg.png" style="width:500px; height:500px;">
        </div>
