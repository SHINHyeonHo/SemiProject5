...
<body>
	<form action="/SemiProject/board/REVupdate.hb?prodCode=${param.prodCode}&revNo=${param.revNo}" method="post" onsubmit="return formCheck();">
	<div id="title"><h2>Q&A</h2></div>
		...
		<table>
			<tr>
				...
				<td><input type="text" name="rev_title" size=70 value="${modifyREV.rev_title}"></td>
			</tr>
			<tr>
				<td class="row1">작성자</td>
				<td colspan="2"><input type="text" name="fk_userid" value="${modifyREV.fk_userid}"></td>
			</tr>
			<tr>
				<td colspan="3" id="txtArea"><textarea name="rev_content">${modifyREV.rev_content}</textarea></td>
			</tr>
			<tr>
