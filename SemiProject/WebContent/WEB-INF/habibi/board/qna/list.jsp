   ...
   <div id="title"><h2>Q&A</h2></div>
    <table>
        ...
        <tr align="center">
            ...
            <td width="400px"><a href='/SemiProject/board/QNAview.hb?prodCode=${param.prodCode}&qnaNo=${list.qna_no}'>${list.qna_title}</a></td>
    ...
    <a id="write" href="/SemiProject/board/QNAwrite.hb?prodCode=${param.prodCode}">글쓰기</a>
