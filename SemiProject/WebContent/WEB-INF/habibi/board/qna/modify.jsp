...
<body>
	<form action="/SemiProject/board/QNAupdate.hb?prodCode=${param.prodCode}&qnaNo=${param.qnaNo}" method="post" onsubmit="return formCheck();">
	<div id="title"><h2>Q&A</h2></div>
		...
		<table>
			<tr>
				...
				<td><input type="text" name="qna_title" size=70 value="${modifyQNA.qna_title}"></td>
			</tr>
			<tr>
				<td class="row1">작성자</td>
				<td colspan="2"><input type="text" name="fk_userid" value="${modifyQNA.fk_userid}"></td>
			</tr>
			<tr>
				<td colspan="3" id="txtArea"><textarea name="qna_content">${modifyQNA.qna_content}</textarea></td>
			</tr>
			<tr>
