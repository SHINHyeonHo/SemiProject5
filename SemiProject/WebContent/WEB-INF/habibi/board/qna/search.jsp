...
<script type="text/javascript">
	...
	function func_search() {    		
		...
		location.href='/SemiProject/board/QNAsearch.hb?prodCode=${param.prodCode}&search=' + val;
	}
...
<div id="qnaPage">
    ...
    <table>
		...
		<c:forEach items="${searchQNA}" var="search">
        <tr align="center">
            <td width="50px">${search.qna_seq}</td>
            <td width="400px"><a href='/SemiProject/board/QNAview.hb?prodCode=${param.prodCode}&qnaNo=${search.qna_no}'>${search.qna_title}</a></td>
            <td width="70px">${search.fk_userid}</td>
            <td width="100px">${search.qna_write_date}</td>
            <td width="50px">${search.qna_count}</td>
        </tr>
		</c:forEach>	
    </table>
