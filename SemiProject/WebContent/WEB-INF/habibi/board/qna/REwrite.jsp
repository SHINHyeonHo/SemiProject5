...
<body>
	<form action="/SemiProject/board/REinsert.hb?prodCode=${param.prodCode}&qnaNo=${param.qnaNo}&p=${param.p}&r=${param.r}&s=${param.s}&l=${param.l}" 
		  method="post" 
	...
	<div id="title"><h2>Q&A</h2></div>
		...
		<table>
			<tr>
				...
				<td><input type="text" name="qna_title" size=70 value="안녕하세요. HABIBI입니다."></td>
			</tr>
			<tr>
			...
			<tr>
				<td colspan="3" id="txtArea">
					<textarea name="qna_content">${viewQNA.qna_content}
-----------------------------------------------------------------------------------------
		...
		<div id="btn" align="center">
			...
			<input type="button" value="취소" class="btn" onClick="location.href='/SemiProject/board/QNAview.hb?prodCode=${param.prodCode}&qnaNo=${param.qnaNo}&p=${param.p}'">
		</div>		
		<input type="hidden" name="re_ref" value="${param.r}">
		<input type="hidden" name="re_seq" value="${param.s + 1}">
		<input type="hidden" name="re_lev" value="${param.l + 1}">
	</div>
	</form>
